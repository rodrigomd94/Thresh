import { TransactionUnspentOutputs, TransactionWitnessSet, Transaction as CMLTransaction } from '@libs/libs/cardano_multiplatform_lib/cardano_multiplatform_lib.generated.js'
...
export interface Wallet {
  ...
  signTx(tx: CMLTransaction): Promise<TransactionWitnessSet>;
  signMessage(
